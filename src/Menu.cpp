...
struct Menu_System Menu[] = {
    { 0,0,       Title_Menu_Op,         "Menu",  Menu_NULL_IMG,              0,                                  0,       *Save_Exit_Menu_System},
    { 0,1,       Jump_Menu_Op,          "Solder Setting",               Menu_NULL_IMG,              1,                                  0,          Menu_NULL_F},
    { 0,2,       Jump_Menu_Op,          "System Setting",               Menu_NULL_IMG,              5,                                  0,          Menu_NULL_F},
    { 0,3,       F_Menu_Op,          "Back",               Menu_NULL_IMG,                0,                                  0,          *Save_Exit_Menu_System},
    // { 0,4,       F_Menu_Op,          "测试",               Menu_NULL_IMG,                0,                                  0,          *(EnterLogo)},
   // { 0,4,       F_Menu_Op,          "重启",               Menu_NULL_IMG,                0,                                  0,          *(SYS_Reboot)},
 
    { 1,0,       Title_Menu_Op,         "Solder Setting",               Menu_NULL_IMG,              0,                                  1,          Menu_NULL_F},
    { 1,1,       Jump_Menu_Op,          "Tips",               IMG_Tip,              2,                                  0,          Menu_NULL_F},
    { 1,2,       Jump_Menu_Op,          "Temperature Scene",             Set1,              3,                                  0,          Menu_NULL_F},
    { 1,3,       Jump_Menu_Op,          "Timer",             Set2,              4,                                  0,          Menu_NULL_F},
    { 1,4,       Jump_Menu_Op,          "Heat Setting",             Set3,              19,                                  0,          Menu_NULL_F},
    { 1,5,       Jump_Menu_Op,          "Back",                Set7,              0,                                  1,          Menu_NULL_F},
 
    { 2,0,       Title_Menu_Op,         "Tips",               Menu_NULL_IMG,              1,                                  1,          Menu_NULL_F},
    { 2,1,       Jump_Menu_Op,          "Change",           Set8,              15,                                  0,          *FlashTipMenu},
    { 2,2,       F_Menu_Op,             "View Curve",           Set0,              0,                                  0,          *ShowCurveCoefficient},
    { 2,3,       F_Menu_Op,             "Calibrate",               Set9,              0,                                  0,          *CalibrationTemperature},
    { 2,4,       Jump_Menu_Op,          "PID",                 Set3,              16,                                  0,    Menu_NULL_F},
    { 2,5,     F_Menu_Op,             "New",               IMG_Files,              0,                                  0,     *NewTipConfig},
    { 2,6,     F_Menu_Op,             "Rename",             IMG_Pen2,              0,                                  0,      *TipRename},
    { 2,7,     F_Menu_Op,             "Delete",               Set10,              0,                                  0,         *TipDel},
    { 2,8,       Jump_Menu_Op,          "Back",               Save,              1,                                  1,          *SaveTipConfig},
 
    { 3,0,       Title_Menu_Op,         "Temperature Scene",               Menu_NULL_IMG,              1,                                  2,          Menu_NULL_F},
    { 3,1,       Progress_Bar_Menu_Op,  "Set",         Set13,              Slide_space_BootTemp,                                  0,          Menu_NULL_F},
    { 3,2,       Progress_Bar_Menu_Op,  "Boost",         Set14,              Slide_space_BoostTemp,                                  0,          Menu_NULL_F},
    { 3,3,       Progress_Bar_Menu_Op,  "Sleep",         Set11,              Slide_space_SleepTemp,                                  0,          Menu_NULL_F},
    { 3,4,       Jump_Menu_Op,          "Back",                  Save,              1,                                  2,          Menu_NULL_F},
 
    { 4,0,       Title_Menu_Op,         "Timer",               Menu_NULL_IMG,              1,                                  3,          Menu_NULL_F},
    { 4,1,       Progress_Bar_Menu_Op,  "Turn off (min)",         Set13,              Slide_space_ShutdownTime,                                               0,          Menu_NULL_F},
    { 4,2,       Progress_Bar_Menu_Op,  "Boost (sec)",         Set14,              Slide_space_BoostTime,                                                0,          Menu_NULL_F},
    { 4,3,       Progress_Bar_Menu_Op,  "Sleep (min)",         Set11,              Slide_space_SleepTime,                                                0,          Menu_NULL_F},
    { 4,4,       Progress_Bar_Menu_Op,  "Screen saver (min)",         Set4,              Slide_space_ScreenProtectorTime,                0,          Menu_NULL_F},
    { 4,5,       Jump_Menu_Op,          "Back",                  Save,              1,                                  3,          Menu_NULL_F},
 
    { 5,0,       Title_Menu_Op,         "System Setting",               Menu_NULL_IMG,              0,                                  2,          Menu_NULL_F},
    { 5,1,       Jump_Menu_Op,          "Personal",               IMG_Pen,              6,                                  0,          Menu_NULL_F},
    { 5,2,       Jump_Menu_Op,          "Update Firmware",                 IMG_BLE,              22,                                  0,          Menu_NULL_F},
    { 5,3,       Progress_Bar_Menu_Op,  "OVP",             Set6,              Slide_space_UndervoltageAlert,                    0,          Menu_NULL_F},
    { 5,4,       F_Menu_Op,             "Password",             Lock,              0,              0,                   *SetPasswd},
    { 5,5,       Jump_Menu_Op,          "Languages",             Set_LANG,              13,                                  0,          Menu_NULL_F},
    { 5,6,       F_Menu_Op,             "About",             QRC,              5,                                  5,          *About},
    { 5,7,       Jump_Menu_Op,          "Back",                 Set7,              0,                                  2,          Menu_NULL_F},
 
    { 6,0,       Title_Menu_Op,         "Personal",               Menu_NULL_IMG,              5,                                  1,          Menu_NULL_F},
    { 6,1,       Jump_Menu_Op,          "Screen",             Set4,              7,                                  0,          Menu_NULL_F},
    { 6,2,       Jump_Menu_Op,          "Sound",             Set5,              10,                                  0,          Menu_NULL_F},
    { 6,3,       Switch_Menu_Op,        "Button Direct",            Set19,           SwitchSpace_RotaryDirection,         0,          *PopMsg_RotaryDirection},
    { 6,4,       Jump_Menu_Op,          "Sleep",             IMG_Trigger,             14,         0,          Menu_NULL_F},
    { 6,5,       Jump_Menu_Op,          "Back",                 Set7,              5,                                  1,          Menu_NULL_F},
 
    { 7,0,       Title_Menu_Op,         "Screen",               Menu_NULL_IMG,              6,                        1,          Menu_NULL_F},
    { 7,1,       Jump_Menu_Op,          "Panel",               Set0,              8,                                  0,          Menu_NULL_F},
    { 7,2,       Switch_Menu_Op,        "Flip",               IMG_Flip,          SwitchSpace_ScreenFlip,               0,        *Update_OLED_Flip},
    { 7,3,       Jump_Menu_Op,          "Animation",               IMG_Animation,    11,                                  0,          Menu_NULL_F},
    { 7,4,       Progress_Bar_Menu_Op,  "Brightness",               IMG_Sun,          Slide_space_ScreenBrightness,        1,          *Update_OLED_Light_Level},
    { 7,5,       Jump_Menu_Op,          "Option bar",             IMG_Size,              9,                                  0,          Menu_NULL_F},
    { 7,6,       Switch_Menu_Op,        "List Mode",             IMG_ListMode,       SwitchSpace_MenuListMode,                                  0,          *PopMsg_ListMode},
    { 7,7,       Jump_Menu_Op,          "Back",                  Set7,              6,                                  1,          Menu_NULL_F},
 
    { 8,0,       Title_Menu_Op,         "Panel",               Menu_NULL_IMG,              7,                                  1,          Menu_NULL_F},
    { 8,1,       SingleBox_Menu_Op,     "Classic",               Set17,              SwitchSpace_PanelSettings,                     0,          *JumpWithTitle},
    { 8,2,       SingleBox_Menu_Op,     "Full",               Set18,              SwitchSpace_PanelSettings,                     1,          *JumpWithTitle},
 
    { 9,0,       Title_Menu_Op,         "Option Bar Test",      Menu_NULL_IMG,              7,                                  5,          Menu_NULL_F},
    { 9,1,       SingleBox_Menu_Op,     "Fixed",                   Menu_NULL_IMG,              SwitchSpace_OptionStripFixedLength, true,          Menu_NULL_F},
    { 9,2,       SingleBox_Menu_Op,     "Adaptive",                 Menu_NULL_IMG,              SwitchSpace_OptionStripFixedLength, false,          Menu_NULL_F},
    { 9,3,       Jump_Menu_Op,          "--- DOWN ---",         Menu_NULL_IMG,              9,                                  4,          Menu_NULL_F},
    { 9,4,       Menu_NULL_OP,          "Opt 1",                   Menu_NULL_IMG,              0,                                  0,          Menu_NULL_F},
    { 9,5,       Menu_NULL_OP,          "Opt 2",               Menu_NULL_IMG,              0,                                  0,          Menu_NULL_F},
    { 9,6,       Menu_NULL_OP,          "Opt 3",      Menu_NULL_IMG,              0,                                  1,          Menu_NULL_F},
    { 9,7,       Menu_NULL_OP,          "Opt 4",                   Menu_NULL_IMG,              0,                                  0,          Menu_NULL_F},
    { 9,8,       Jump_Menu_Op,          "--- UP ---",         Menu_NULL_IMG,              9,                                  0,          Menu_NULL_F},
    { 9,9,       Jump_Menu_Op,          "Back",                   Menu_NULL_IMG,              7,                                  5,          Menu_NULL_F},
 
    { 10,0,       Title_Menu_Op,         "Sound",               Menu_NULL_IMG,              6,                                  2,          Menu_NULL_F},
    { 10,1,       SingleBox_Menu_Op,     "ON",               Set5,              SwitchSpace_Volume,                              true,          *JumpWithTitle},
    { 10,2,       SingleBox_Menu_Op,     "OFF",               Set5_1,              SwitchSpace_Volume,                            false,          *JumpWithTitle},
 
    { 11,0,       Title_Menu_Op,         "Animation",               Menu_NULL_IMG,              7,                                  3,          Menu_NULL_F},
    { 11,1,       SingleBox_Menu_Op,     "ON",               IMG_Animation,                  SwitchSpace_SmoothAnimation,        true,          *JumpWithTitle},
    { 11,2,       SingleBox_Menu_Op,     "OFF",               IMG_Animation_DISABLE,          SwitchSpace_SmoothAnimation,        false,          *JumpWithTitle},
 
    { 12,0,       Title_Menu_Op,         "Heat Mode",               Menu_NULL_IMG,              19,                                  2,          Menu_NULL_F},
    { 12,1,       SingleBox_Menu_Op,     "PID",               Set16,               SwitchSpace_PIDMode,                        true,          *JumpWithTitle},
    { 12,2,       SingleBox_Menu_Op,     "Direct",              Set15,      SwitchSpace_PIDMode,                                 false,          *JumpWithTitle},
 
    { 13,0,       Title_Menu_Op,         "Languages",               Menu_NULL_IMG,              5,                                  5,          Menu_NULL_F},
    { 13,1,       SingleBox_Menu_Op,     "English",               Lang_CN,               SwitchSpace_Language,                    LANG_Chinese,          *JumpWithTitle},

    { 14,0,       Title_Menu_Op,         "Sleep",               Menu_NULL_IMG,              6,                                  4,          Menu_NULL_F},
    { 14,1,       SingleBox_Menu_Op,     "IMU",               IMG_VibrationSwitch,        SwitchSpace_HandleTrigger,          0,          *JumpWithTitle},
    { 14,2,       SingleBox_Menu_Op,     "NULL",                 IMG_ReedSwitch,             SwitchSpace_HandleTrigger,          1,          *JumpWithTitle},
 
    { 15,0,       Title_Menu_Op,         "Tips",             Menu_NULL_IMG,              2,                                  1,          *LoadTipConfig},
    ...
    { 16,0,       Title_Menu_Op,         "PID",             Menu_NULL_IMG,              2,                                  3,          Menu_NULL_F },
    { 16,1,       Jump_Menu_Op,          "Fast Range",               Menu_NULL_IMG,      17,                                 0,          Menu_NULL_F },
    { 16,2,       Jump_Menu_Op,          "Slow Range",               Menu_NULL_IMG,      18,                                 0,          Menu_NULL_F },
    { 16,3,       Jump_Menu_Op,          "Back",                   Menu_NULL_IMG,           2,                                  3,          Menu_NULL_F },

    { 17,0,       Title_Menu_Op,         "Fast Range",             Menu_NULL_IMG,            16,                                 1,          *SaveTipConfig },
    { 17,1,       Progress_Bar_Menu_Op,  "P",               Menu_NULL_IMG,              Slide_space_PID_AP,                 0,          Menu_NULL_F },
    { 17,2,       Progress_Bar_Menu_Op,  "I",               Menu_NULL_IMG,              Slide_space_PID_AI,                 0,          Menu_NULL_F },
    { 17,3,       Progress_Bar_Menu_Op,  "D",               Menu_NULL_IMG,              Slide_space_PID_AD,                 0,          Menu_NULL_F },
    { 17,4,       Jump_Menu_Op,          "Back",                   Menu_NULL_IMG,           16,                                 1,          *SaveTipConfig },

    { 18,0,       Title_Menu_Op,         "Slow Range",             Menu_NULL_IMG,            16,                                 2,          *SaveTipConfig },
    { 18,1,       Progress_Bar_Menu_Op,  "P",               Menu_NULL_IMG,              Slide_space_PID_CP,                 0,          Menu_NULL_F },
    { 18,2,       Progress_Bar_Menu_Op,  "I",               Menu_NULL_IMG,              Slide_space_PID_CI,                 0,          Menu_NULL_F },
    { 18,3,       Progress_Bar_Menu_Op,  "D",               Menu_NULL_IMG,              Slide_space_PID_CD,                 0,          Menu_NULL_F },
    { 18,4,       Jump_Menu_Op,          "Back",                   Menu_NULL_IMG,           16,                                 2,          *SaveTipConfig },

    { 19,0,       Title_Menu_Op,         "Heat Setting",             Menu_NULL_IMG,            1,                                 4,          Menu_NULL_F },
    { 19,1,       Switch_Menu_Op,        "PID Mode",               Menu_NULL_IMG,           SwitchSpace_PIDMode,                                0,          Menu_NULL_F },
    { 19,2,       Progress_Bar_Menu_Op,  "Sample/Heat %",               Menu_NULL_IMG,        Slide_space_SamplingRatioWork,                 0,          Menu_NULL_F },
    { 19,3,       Jump_Menu_Op,          "Sample Cycle(ms)",               Menu_NULL_IMG,           21,                 0,          Menu_NULL_F },
    { 19,4,       Jump_Menu_Op,          "Kalman Filter",               Menu_NULL_IMG,      20,                 0,          Menu_NULL_F },
    { 19,5,       Jump_Menu_Op,          "Back",                   Menu_NULL_IMG,          1,                                 4,          Menu_NULL_F },

    { 20,0,       Title_Menu_Op,         "Kalman Filter",             Menu_NULL_IMG,            19,                                 4,          Menu_NULL_F },
    { 20,1,       Switch_Menu_Op,        "State",               Menu_NULL_IMG,              SwitchSpace_KFP,                 0,          Menu_NULL_F },
    { 20,2,       Progress_Bar_Menu_Op,  "Q",               Menu_NULL_IMG,         Slide_space_KFP_Q,               0,          Menu_NULL_F },
    { 20,3,       Progress_Bar_Menu_Op,  "R",               Menu_NULL_IMG,         Slide_space_KFP_R,                 0,          Menu_NULL_F },
    { 20,4,       Jump_Menu_Op,          "Back",                   Menu_NULL_IMG,          19,                                 4,          Menu_NULL_F },

    { 21,0,       Title_Menu_Op,         "Sample Cycle",             Menu_NULL_IMG,            19,                                 3,          Menu_NULL_F },
    { 21,1,       Progress_Bar_Menu_Op,  "difference >150",               Menu_NULL_IMG,          Slide_space_ADC_PID_Cycle_List_0,   0,          Menu_NULL_F },
    { 21,2,       Progress_Bar_Menu_Op,  "difference >50",               Menu_NULL_IMG,           Slide_space_ADC_PID_Cycle_List_1,   0,          Menu_NULL_F },
    { 21,3,       Progress_Bar_Menu_Op,  "difference ≤50",               Menu_NULL_IMG,           Slide_space_ADC_PID_Cycle_List_2,   0,          Menu_NULL_F },
    { 21,4,       Jump_Menu_Op,          "Back",                   Menu_NULL_IMG,          19,                                 3,          Menu_NULL_F },

    { 22,0,       Title_Menu_Op,         "Update Firmware",             Menu_NULL_IMG,            5,                                 2,          Menu_NULL_F },
    { 22,1,       Switch_Menu_Op,        "State",               Menu_NULL_IMG,         SwitchSpace_BLE_State,   0,          *BLE_Restart },
    // { 22,2,       F_Menu_Op,             "设备名称",          Menu_NULL_IMG,          22,   2,          *BLE_Rename },
    { 22,2,       Jump_Menu_Op,          "Back",               Menu_NULL_IMG,          5,                                 2,          Menu_NULL_F },
};
/***
